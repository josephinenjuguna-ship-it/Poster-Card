function PosterSubtext() {
  return (
    <div className="bg-black text-white px-10 pb-10">
      ...
      <blockquote className="italic text-orange-400 text-2xl mt-10">
        "Precision in every shot, mastery in every move."
      </blockquote>
    </div>
  );
}
